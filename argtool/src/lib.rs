...
//! In order to parse to vec and scaler in rust, we use an Enum
//! [ArgValue](argitem::ArgValue) to stored value [STR](argitem::ArgValue::STR)
//! and [STR](argitem::ArgValue::VEC). You can parse it as different type
//! according to the parse function used. (e.g. get_bool, get_vec) They will be
//! parse only when you want to get them out of [ArgGroup](argroup::ArgGroup).
//!
...
pub use argitem::{ArgItem, ArgType, ArgValue};
